...
stopwatch and licor
```{r}
datafile="M_TG20-01075-2024-05-02T082500.data"
remark="T1_2"
...
extra=data[10614:10814,]
dat=data[c((data$REMARK==remark)),]
dat=rbind(dat,extra)
...
t_adjust=c(0,0,0,10,20,0,0,10,20,0,0)
t=t+t_adjust
```

Let's check again
```{r}
plot(dat$SECONDS,dat$N2O, col="darkgreen", xlim=c(t[7],t[11]))
abline(v=t, col="steelblue")
abline(v=N2O_max_index, col="red")
abline(v=(N2O_max_index[10]-15))
abline(v=(N2O_max_index[10]-3))
abline(v=(N2O_max_index[10]+40))
abline(v=(N2O_max_index[10]+55))
```

Times look good! Let's create sample intervals of 90 seconds to extract the N2O data we need from dat.
{r}
sample_interval=c()
for (i in t) {
...
write.csv(sum_sampledat, file="T1_2_final")
plot(t,N2O_ppb)
hist(N2O_ppb)
boxplot(N2O_ppb)
```
