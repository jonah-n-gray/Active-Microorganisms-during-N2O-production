...
t_adjust=c(0,25,25,0,0,25,0,0,25,20)
t=t+t_adjust
```

Let's check again
```{r}
plot(dat$SECONDS,dat$N2O, col="darkgreen", xlim=c(t[1],t[5]))
abline(v=t, col="steelblue")
...
t=t[1:9]
sample=seq(1,length(t),1)
sum_sampledat=data.frame(sample,t,N2O_ppb,mg_N2O_N,syringe_N2O)
write.csv(sum_sampledat, file="T4_1_final")
plot(t,N2O_ppb)
hist(N2O_ppb)
boxplot(N2O_ppb)
boxplot(mg_N2O_N)
